...
└── README.md`,
    ...
    echarts: { series: "tree", docs: echartsDocs("tree") },
  },
  {
    id: "treemap",
    name: "Treemap",
...
"Design"
  ...
  "Social" : 25`,
    ...
    shadcn: { block: "chart-pie-donut", docs: shadcnDocs("pie") },
    echarts: { series: "pie", docs: echartsDocs("pie") },
  },
  ...
  bar [60, 75, 90, 110]`,
    ...
    shadcn: { block: "chart-bar-default", docs: shadcnDocs("bar") },
    echarts: { series: "bar", docs: echartsDocs("bar") },
  },
  {
    id: "line",
    name: "Line",
  ...
  line [120, 180, 240, 310, 390, 460]`,
    ...
    shadcn: { block: "chart-line-default", docs: shadcnDocs("line") },
    echarts: { series: "line", docs: echartsDocs("line") },
  },
  {
    id: "area",
    name: "Area",
    ...
    shadcn: { block: "chart-area-default", docs: shadcnDocs("area") },
    echarts: {
      series: "line",
  ...
  min 0`,
    ...
    shadcn: { block: "chart-radar-default", docs: shadcnDocs("radar") },
    echarts: { series: "radar", docs: echartsDocs("radar") },
  },
  {
    id: "radial",
    name: "Radial Bar",
    ...
    shadcn: { block: "chart-radial-simple", docs: shadcnDocs("radial") },
    echarts: {
      series: "bar",
  ...
  },
  {
    ...
    echarts: { series: "gauge", docs: echartsDocs("gauge") },
  ...
  },
  {
    ...
    echarts: { series: "heatmap", docs: echartsDocs("heatmap") },
  },
  {
    id: "funnel",
    name: "Funnel",
  ...
  },
  {
    ...
    echarts: { series: "boxplot", docs: echartsDocs("boxplot") },
  },
  {
    id: "candlestick",
    name: "Candlestick",
    ...
    echarts: { series: "candlestick", docs: echartsDocs("candlestick") },
  },
